            ...
            <v-layout row wrap>
                <v-flex xs4>
                    <v-container grid-list-md>
                        <v-layout row wrap>
                            <v-flex xs12>
                                <v-img height=320px width=320px src="http://civilcode.ge/images/2/24/Blank-avatar.png"/>
                            </v-flex>
                        </v-layout>
                    </v-container>
                </v-flex>
                    ...
                    <v-container grid-list-md>
                        <v-layout row wrap>
                            <v-flex xs12>
                                ...
                                <v-flex xs12>
                                    <v-text-field v-model="phone" :mask="mask" solo hide-details label="Contact Number"></v-text-field>
                                </v-flex>
                                <v-flex xs12>
                                    <v-text-field
                                        v-model="password"
